...
export const tr = {
  ...
  home: {
    ...
    services: {
      ...
      cta: "Ücretsiz Rehberlerimize Göz Atın",
    },
    guides: {
      eyebrow: "Ücretsiz Rehberler",
      title: "Sizin",
      titleEm: "için.",
...
export const en: Dictionary = {
  ...
  home: {
    ...
    services: {
      ...
      card1Title: "Buying",
      card1Desc:
        "Residential, investment, or commercial — we find the right property at the right price at the right time. By your side from search to closing.",
      card2Title: "Selling",
      card2Desc:
        "Professional marketing, pricing strategy, and strong negotiation to sell any real estate on the best possible terms.",
      cta: "Browse Our Free Guides",
    },
    guides: {
      eyebrow: "Free Guides",
      title: "For",
      titleEm: "you.",
      sub: "Start your buying or selling journey with the right steps. View or download your guide for free.",
      card1Label: "Buy",
