...
export const LEGAL_CONTACT = {
  ...
  legalEmail: "legal@jackhunter.com", // TODO: confirm
};
...
const LIC = "FSRA Lisans No: 10464";
const LIC_EN = "FSRA Licence No: 10464";
...
const tr: Record<LegalKey, LegalDoc> = {
  privacy: {
    metaTitle: "Gizlilik Politikası · RMA Mortgage",
    eyebrow: "Yasal",
    ...
    sections: [
      {
        heading: "Giriş",
        blocks: [
          p("Mortgage hizmetleri, Ontario'da lisanslı bir mortgage brokerage olan RMA Mortgage (birlikte “biz”, “bize” veya “bizim”) bünyesinde sunulur. Bu Gizlilik Politikası, mortgage danışmanlık hizmetlerimizi kullandığınızda kişisel bilgilerinizi nasıl topladığımızı, kullandığımızı, paylaştığımızı ve koruduğumuzu açıklar."),
  ...
  terms: {
    metaTitle: "Kullanım Koşulları · RMA Mortgage",
    eyebrow: "Yasal",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          p("Bu sitede bir lender teklifinin veya ürününün sunulması, o lender'ın tavsiye edildiği veya onaylandığı anlamına gelmez. Tüm mortgage başvuruları, sizin tarafınızdan bir teklif olarak lender'lara sunulur; nihai kredi kararını RMA Mortgage değil, lender verir."),
  ...
  advertising: {
    metaTitle: "Reklam Açıklaması · RMA Mortgage",
    eyebrow: "Yasal",
    title: "Reklam Açıklaması",
    lastModifiedLabel: "Son güncelleme",
    sections: [
      {
        heading: "RMA Mortgage Hizmeti",
        blocks: [
          p(`Mortgage hizmetleri, Ontario'da faaliyet gösteren lisanslı bir mortgage brokerage olan RMA Mortgage bünyesinde sunulur. Mortgage aracılık hizmetleri, Ontario Finansal Hizmetler Düzenleme Kurumu (FSRA) tarafından düzenlenir. ${LIC}.`),
          p("RMA Mortgage, mortgage'lar fonlandığında lender'lardan komisyon alabilir. Bu komisyonlar lender tarafından ödenir, sizin tarafınızdan değil. Borçluya herhangi bir ücretin uygulandığı durumlarda, herhangi bir taahhüt imzalamadan önce yazılı ve sade bir dille açıklanır."),
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          p("RMA Mortgage ile WhatsApp, telefon, e-posta veya başka bir kanal aracılığıyla etkileşime girdiğinizde; mortgage rehberliği sağlamak ve dosyanızı uygun lender'larla buluşturmak için adınızı, iletişim bilgilerinizi, finansal bilgilerinizi ve mülk ayrıntılarınızı toplayabiliriz."),
...
const en: Record<LegalKey, LegalDoc> = {
  privacy: {
    metaTitle: "Privacy Policy · RMA Mortgage",
    eyebrow: "Legal",
    ...
    sections: [
      {
        ...
        blocks: [
          p("Mortgage services are offered through RMA Mortgage (collectively, “we”, “us”, or “our”), a licensed mortgage brokerage in Ontario. This Privacy Policy describes how we collect, use, disclose, and protect personal information when you use our mortgage advisory services."),
  ...
  terms: {
    metaTitle: "Terms of Use · RMA Mortgage",
    eyebrow: "Legal",
    title: "Terms of Use",
    lastModifiedLabel: "Last modified",
    sections: [
  ...
  advertising: {
    metaTitle: "Advertising Disclosure · RMA Mortgage",
    eyebrow: "Legal",
    title: "Advertising Disclosure",
    lastModifiedLabel: "Last modified",
    sections: [
      {
        heading: "RMA Mortgage Service",
        blocks: [
          p(`Mortgage services are offered through RMA Mortgage, a licensed mortgage brokerage operating in Ontario. Mortgage brokerage services are regulated by the Financial Services Regulatory Authority of Ontario (FSRA). ${LIC_EN}.`),
          p("RMA Mortgage may receive commissions from lenders when mortgages are funded. These commissions are paid by the lender, not by you. Where any fee applies to the borrower, it is disclosed in writing and in plain language before you sign any commitment."),
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          p("When you interact with RMA Mortgage through WhatsApp, phone, email, or another channel, we may collect your name, contact information, financial information, and property details in order to provide mortgage guidance and connect your file with suitable lenders."),
