...
Prepared for Jack Hunter · Hunter Group Real Estate / RMA Mortgage
...
- Keep the disclosure modal logic: rates are examples only, not guaranteed; approval depends on file/lender; borrower fees disclosed before commitment; mortgage activity is conducted through **RMA Mortgage** (insert exact authorized name + FSRA licence # before launch — currently a launch-blocking blank in the plan doc).
...
*Open blanks to fill before launch: exact RMA Mortgage authorized name + FSRA licence number; confirmation that a "Hunter" master domain sits within RE/MAX franchise branding standards.*
