...
This is the documentation folder for the single Hunter Group app at the repo root.

- **The live site** lives at the repo root (`app/`, `components/`, `lib/`). Run it with `npm run dev`.
