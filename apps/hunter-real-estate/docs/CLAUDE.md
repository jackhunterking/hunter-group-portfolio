...
2. **Keep the two regulated identities separate.** RE/MAX Hallmark (real estate) and RMA Mortgage (mortgage) never share a disclosure block or brokerage label. Mortgage pages carry RMA + FSRA identity; real-estate pages carry RE/MAX.
